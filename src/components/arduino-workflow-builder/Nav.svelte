...
<nav class:small={!$authStore.isLoggedIn}>
  <a href="/" class="logos">
    <span class="arduino-workflow" style="font-weight: bold; font-size: 2.2rem; color: #505bda; margin-right: 60px; position: relative; left: 20px; top: 20px;">AWB</span>
  </a>
