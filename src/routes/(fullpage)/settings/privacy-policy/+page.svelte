<svelte:head>
  <title>Wireloop - Privacy Policy</title>
</svelte:head>

<div class="row">
  <div class="col">
    <h1>Privacy Policy for Wireloop</h1>

    <p>
      At Wireloop, accessible from https://arduino-workflow-builder.org, one of our
      main priorities is the privacy of our visitors. This Privacy Policy
      document contains types of information that is collected and recorded by
      Wireloop and how we use it.
    </p>
    ...
    <p>
      ...
      and/or collect in Wireloop. This policy is not applicable to any
    ...
    <p>
      Wireloop follows a standard procedure of using log files. These files
    ...
    <p>
      Like any other website, Wireloop uses 'cookies'. These cookies are
    ...
    <p>
      ...
      advertising partners of Wireloop.
    </p>

    <p>
      Third-party ad servers or ad networks uses technologies like cookies,
      JavaScript, or Web Beacons that are used in their respective
      advertisements and links that appear on Wireloop, which are sent
    ...
    <p>
      Note that Wireloop has no access to or control over these cookies
    ...
    <p>
      Wireloop's Privacy Policy does not apply to other advertisers or
    ...
    <p>
      Wireloop does not knowingly collect any Personal Identifiable
